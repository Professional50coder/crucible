 ...
 * Crucible's daemon acknowledges automatically, well inside the window.
 *
...
export const AUTO_ACK_POLICY =
  'Crucible acknowledges as soon as the adapter is retrievable — about two minutes after ' +
  'delivery — and retries on failure. If retries are still failing six hours before the ' +
  'deadline, it escalates rather than letting the window close.'
